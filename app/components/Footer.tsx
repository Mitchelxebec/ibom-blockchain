      ...
      <div className="w-full max-w-360.25 mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6 pt-8 border-t border-white/10">
          ...
          <p className="font-sans text-[12px] md:text-[14px] font-normal text-gray-400">
            © {year} Ibom Blockchain Xperience. All rights reserved.
          </p>

          {/* Social Media Icons */}
          <div className="flex gap-4">
            <a
              href="https://x.com/IbomBlockchain?t=ByiII5E8klmxqcUVNHuS_A&s=09"
              className="w-10 h-10 flex items-center justify-center hover:text-orange-500 transition"
              aria-label="Twitter"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/company/ibom-blockchain-summit/"
              className="w-10 h-10 flex items-center justify-center hover:text-orange-500 transition"
              aria-label="LinkedIn"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.facebook.com/share/16rxXKqb8m/"
              className="w-10 h-10 flex items-center justify-center hover:text-orange-500 transition"
              aria-label="Facebook"
              target="_blank"
              rel="noopener noreferrer"
